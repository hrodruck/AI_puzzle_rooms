...
rooms_dict['room_1'] = {
    'room':{
        'description': {
            ...
            'torch': 'This torch is the only light source in the room. It can be moved from it\'s place by the player. It can also be snuffed and put out, though it is plenty of fuel.',
...
rooms_dict['room_2'] = {
    'room':{
        'description': {
            ...
            "riddle": "A riddle about having to select the correct path out of two. Avoid changing the initial riddle. The riddle is presented to the player at all times.",
            'player_body': 'The player\'s own body, full of physical characteristics. The player is a regular, able adventurer. Keep track of things concerning the player body only, not other surounding objects or features. Always reply in first person, from the perspective of a game avatar.',
            'inventory': 'The player set of possessions. It is initially empty',
        },
