...
rooms_dict['room_6'] = {
  "room": {
    "description": {
      ...
      "inventory": "The player set of possessions. It initially contains a pair of insulated scissors. The scissors are too big to fit the lever opening.",
