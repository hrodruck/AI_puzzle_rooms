...
rooms_dict['mage_tower_room_entrance_lvl_2'] = {
  "room": {
    "description": {
        "prompts": {
            "win_condition": "The player wins when they whisper the word 'Placate' and they are not observed by a magical eye.",
            ...
            "player_entrapment": "The player is initially free to move as they wish, except that, if they leave the clearing they're in and wander through the forest, they'll return to the clearing after walking around in circles. While the mysterious_fog state is active, the player is always teleported to inside the magic circle and is unable to leave it. The effects of the player entrapment should not be told to the player before they happen.",
            ...
            "ominous_voice": "This object generates witty, sarcastic, and sometimes helpful remarks to the player, commenting on their actions. The messages from this object should be transmitted directly to the player.",
            ...
            "whisper_guardian": "This object is always observing if the player whispered a password. The password is 'goldfish'. Every time the player says that word, the mysterious_fog state activates. The password for this object is a secret and should not be revealed to the player.",
            ...
            "watched_status": "The player is initially not watched. But, when the mysterious_fog effect is activated by the first time, a purple eye appears in the sky and keeps screaming 'AAHHH' and the counter number from magical_usage_counter to the player. This eye has all the limitations of common vision and it watches the player. If this object for some reason can't see the player, the magical_usage_counter also can't decrement their counter. The eye disappears and reappears with the myterious_fog, but the counter never resets.",
            ...
            "mystery_book": "This object is initially inactive. This object represents the book that appears with the mystery_table. It contains a secret message within it's pages, which says 'Tip: say \"Placate\". MWahuahauha!!'. However, the player initially can't see this message, given that only the first page of the book is initially displayed, and that page is blank. The player can see the other pages if they manage to turn the book pages somehow. Other than those characteristics, this is a normal book.",
            "mystery_displayed_page": "This object is initially inactive. This tracks whether the visible page of the mystery_book is just a blank page (initial state) or if that state has changed to another page, revealing the secret message within.",
        ...
        "responsibilities": {
            ...
            "whisper_guardian": "This object checks for a specific word and controls the mysterious_fog state",
            ...
            "mysterious_fog": "This object tracks the mysterious_fog state and explains its properties. It contains secrets.",
        }
    },
    "winning_message": "You observe a tall stone tower materialize in front of you! It looks old, sturdy and imponent. You can now enter it. The password to for the next room is \"skybox\"\n",
    "losing_message": "You were caught using magic too much! You lose.\n",
