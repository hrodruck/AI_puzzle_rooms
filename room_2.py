description = {
        ...
        'lose_condition': 'An abstract entity to represent the lose condition "the player has taken the door caleld door_001". The player loses when they open the door called "door_001" or otherwise leave the room. This abstract object states whether that happened or not.',
        ...
        'player_body': 'The player\'s own body, full of physical characteristics',
    }

winning_message = "Congratulations! You've opened the correct door!"    

losing_message = "What a shame! You opened the wrong door!"    
